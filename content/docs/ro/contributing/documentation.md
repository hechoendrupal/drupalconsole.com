...
Note: The files are located in `/path/directory/drupalconsole.com/content/docs/ro`
...
```
 drupal develop:doc:data --path=/path/directory/drupalconsole.com/content/data/commands-ro.json 
 ```
