...
Note: The files are located in ```/path/directorio/drupalconsole.com/content/docs/ca```
...
```
 drupal develop:doc:data --path=/path/directorio/drupalconsole.com/content/data/commands-ca.json 
 ```
