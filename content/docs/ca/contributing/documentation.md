...
Note: The files are located in `/path/directory/drupalconsole.com/content/docs/ca`
...
```
 drupal develop:doc:data --path=/path/directory/drupalconsole.com/content/data/commands-ca.json 
 ```
