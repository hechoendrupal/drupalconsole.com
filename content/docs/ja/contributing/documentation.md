...
Note: The files are located in `/path/directory/drupalconsole.com/content/docs/ja`
...
``` 
drupal develop:doc:data --path=/path/directory/drupalconsole.com/content/data/commands-ja.json 
```
