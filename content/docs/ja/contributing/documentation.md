...
Note: The files are located in ```/path/directorio/drupalconsole.com/content/docs/ja```
...
``` 
drupal develop:doc:data --path=/path/directorio/drupalconsole.com/content/data/commands-ja.json 
```
