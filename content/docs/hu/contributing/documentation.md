...
Note: The files are located in `/path/directory/drupalconsole.com/content/docs/hu`
...
``` 
drupal develop:doc:data --path=/path/directory/drupalconsole.com/content/data/commands-hu.json 
```
