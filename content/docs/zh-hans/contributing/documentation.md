...
Note: The files are located in ```/path/directorio/drupalconsole.com/content/docs/zh-hans```
...
``` 
drupal develop:doc:data --path=/path/directorio/drupalconsole.com/content/data/commands-zh-hans.json 
```
