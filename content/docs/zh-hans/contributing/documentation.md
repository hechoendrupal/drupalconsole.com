...
Note: The files are located in `/path/directory/drupalconsole.com/content/docs/zh-hans`
...
``` 
drupal develop:doc:data --path=/path/directory/drupalconsole.com/content/data/commands-zh-hans.json 
```
