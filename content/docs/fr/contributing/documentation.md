...
Note: The files are located in `/path/directory/drupalconsole.com/content/docs/fr`
...
``` 
drupal develop:doc:data --path=/path/directory/drupalconsole.com/content/data/commands-fr.json 
```
