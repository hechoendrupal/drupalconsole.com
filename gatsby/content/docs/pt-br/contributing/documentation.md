...
Note: The files are located in `/path/directory/drupalconsole.com/content/docs/pt-br`
...
``` 
drupal develop:doc:data --path=/path/directory/drupalconsole.com/content/data/commands-pt-br.json 
```
